 ...
 * @author ALKODS
 */
public class DebitInformationExtractor implements GeneralInfoExtractor{

    private DebitCard card;
    private OperationsDAO dao;
    
    //Cons
    public DebitInformationExtractor(DebitCard card) {
        this.card = card;
    ...
    public void extractCardPassword() throws SQLException {
        ...
        String query = "SELECT * FROM debit_cards WHERE card_number = '" + card.getCardNumber() + "'";
    ...
    public void extractDepositAmount() throws SQLException {
        //Prepare SQL Query To Get Actual Password
        String query = "SELECT * FROM account_holders WHERE asso_card_id = '" + card.getCardNumber() + "'";
    ...
    public void extractAssociatedAccount() throws SQLException{
        //Prepare SQL Query To Get Actual Password
        String query = "SELECT * FROM account_holders WHERE asso_card_id = '" + card.getCardNumber() + "'";
        ...
        //Set Card Associated Account Number
        card.setAssociatedAccountNum(accountNumber); 
    }
