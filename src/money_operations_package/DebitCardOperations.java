 ...
 * @author ALKODS
 */
public class DebitCardOperations extends MoneyOperations{
    
    OperationsDAO dao; 
    
    //Cons
    public DebitCardOperations() {
    ...
    public void withdraw(Card card, double amount) throws SQLException {
        ...
        if(availableMoney >= amount){
            ...
            String query = "UPDATE account_holders SET deposit_amount = deposit_amount - " + amount + " WHERE asso_card_id = '" + card.getCardNumber() + "'";
    ...
    public void transfer(Card source, AccountHolder destination, double amount) throws SQLException {
        ...
        if(amount <= availableMoney){
            ...
            query1 = "UPDATE account_holders SET deposit_amount = deposit_amount - " + amount + " WHERE asso_card_id = '" + source.getCardNumber() + "'";
